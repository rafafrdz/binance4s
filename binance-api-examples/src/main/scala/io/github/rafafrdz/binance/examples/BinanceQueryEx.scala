...
object BinanceQueryEx {
  ...
  val convertTradeHistoryQuery: BinanceQuery =
    startTime("20/08/2022 17:15:00").endTime("24/08/2022").timestamp

  /** Style 2 - Using milliseconds */
  val convertTradeHistory2: BinanceQuery =
    startTime(1654378632000L) & endTime(1661292000000L) & timestamp
  ...
  val convertTradeHistory4: BinanceQuery =
    startTime("2022/08/20 17:15:00") & endTime("2022-08-24") & timestamp

  /** Style 5 - Using what you want */
  val convertTradeHistory5: BinanceQuery =
    startTime("20/08/2022 17:15:00") & endTime(1661292000000L) & timestamp
}
